...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:FrogCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\FrogCoin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\FrogCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\FrogCoin.lnk"

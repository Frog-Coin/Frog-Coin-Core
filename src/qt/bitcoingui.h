...
/**
  FrogCoin GUI main class. This class represents the main window of the FrogCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FrogCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit FrogCoinGUI(QWidget *parent = 0);
    ~FrogCoinGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a FrogCoin  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */

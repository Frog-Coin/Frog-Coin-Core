...
/** FrogCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FrogCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FrogCoinUnits(QObject *parent);
...
typedef FrogCoinUnits::Unit FrogCoinUnit;

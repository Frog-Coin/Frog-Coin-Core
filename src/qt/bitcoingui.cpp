 ...
 * The FrogCoin Developers 2018-2020
 */
...
FrogCoinGUI::FrogCoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("FrogCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("FrogCoin");
    setStyleSheet("#FrogCoin { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void FrogCoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FrogCoin address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About FrogCoin"), this);
    aboutAction->setToolTip(tr("Show information about FrogCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FrogCoin"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit FrogCoin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for FrogCoin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit FrogCoin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for FrogCoin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where FrogCoin data is stored"));
...
//void FrogCoinGUI::createMenuBar()
//{
//#ifdef Q_OS_MAC
...
void FrogCoinGUI::createToolBars()
{
...
void FrogCoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FrogCoin client") + QString(" ") + tr("[testnet]"));
...
void FrogCoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void FrogCoinGUI::setMessageModel(MessageModel *messageModel)
{
...
void FrogCoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("FrogCoin client"));
...
#ifndef Q_OS_MAC
void FrogCoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void FrogCoinGUI::optionsClicked()
{
...
void FrogCoinGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void FrogCoinGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void FrogCoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FrogCoin network", "", count));
}

void FrogCoinGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void FrogCoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("FrogCoin") + " - ";
...
void FrogCoinGUI::error(const QString &title, const QString &message, bool modal)
{
...
void FrogCoinGUI::changeEvent(QEvent *e)
{
...
void FrogCoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void FrogCoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(FrogCoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void FrogCoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(FrogCoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void FrogCoinGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void FrogCoinGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#FrogCoin { background-image: url(:/images/background_light_alt); }");
}

void FrogCoinGUI::gotoBlockBrowser()
{
...
void FrogCoinGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#FrogCoin { background-image: url(:/images/background_light); }");
}

void FrogCoinGUI::gotoHistoryPage()
{
...
void FrogCoinGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void FrogCoinGUI::gotoAddressBookPage()
{
...
void FrogCoinGUI::gotoReceiveCoinsPage()
{
...
void FrogCoinGUI::gotoSendCoinsPage()
{
...
void FrogCoinGUI::gotoSignMessageTab(QString addr)
{
...
void FrogCoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void FrogCoinGUI::gotoMessagePage()
{
...
void FrogCoinGUI::gotoSettingsPage()
{
...
void FrogCoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void FrogCoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FrogCoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void FrogCoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void FrogCoinGUI::setWalletUnlockStakingOnly()
{
...
void FrogCoinGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void FrogCoinGUI::setEncryptionStatus(int status)
{
...
void FrogCoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void FrogCoinGUI::importPrivateKey()
{
...
void FrogCoinGUI::changePassphrase()
{
...
void FrogCoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void FrogCoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void FrogCoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void FrogCoinGUI::updateStakingIcon()
{
    updateWeight();
...
void FrogCoinGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void FrogCoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {

...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeFrogCoinersed READ rangeFrogCoinersed WRITE setRangeFrogCoinersed)
...
public:
  ...
  */
  ...
  bool rangeFrogCoinersed() const { return mRangeFrogCoinersed; }
  ...
  void setRangeFrogCoinersed(bool reversed);

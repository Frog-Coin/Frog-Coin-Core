...
const string strMessageMagic = "FrogCoin Signed Message:\n";
                               ...
                               bool fBlock, bool fMiner, MapPrevTx& inputsRet, bool& fInvalid) const
{
    ...
    for (unsigned int i = 0; i < vin.size(); i++)
    {
        ...
        {
            // FrogCoinisit this if/when transaction replacement is implemented and allows
            // adding inputs:
            fInvalid = true;
